...
## Course project 1 solution - part4 
## May 2014
...
## plotting the fourth plot to the PNG graphic device
...
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),col=c("black","red","blue"),lwd=1,bty="n", cex=0.9)
